...
export default function PorquePeru() {
  ...
  return (
    <div className="porqueperu">
      ...
      <div className="porqueperu-content">
        <h1>¿POR QUÉ PERÚ?</h1>
        <p>
          ...
          marcada por la presencia de la Cordillera de los Andes que origina
          gran diversidad de climas, flora y fauna. El Perú tiene 84 de las 117
        ...
        <div className="porqueperu-regiones">
          <ul className="porqueperu-regiones-ul">
            <li>
              ...
              formados por los ríos en las alturas de la cordillera de los
              Andes.
            </li>
            <li>
              La sierra, con impresionantes montañas que alcanzan 6,768 m.s.n.m.
              y el altiplano que rodea al Lago Titicaca.
            </li>
            <li>
        ...
        <p>
          El mar peruano es uno de los más ricos del mundo, debido al encuentro
          de las corrientes del Niño y de Humboldt que originan uno de los
          ecosistemas más diversos en el planeta, con 1,800 especies de peces.
        </p>
        <p>
          Tenemos más de 3000 variedades de papa, más de 350 variedades de ajíes
          y más de 50 variedades de maíz; toda esta riqueza ha permitido
          desarrollar una de las mejores gastronomías del mundo. Lima, capital
          gastronómica, alberga tres de los mejores restaurantes a nível
          mundial: Central, Maido y Mayta.
        </p>
        <p>
          ...
          considerada la primera civilización del continente americano y Cusco
          fue capital del imperio Inca. Perú cuenta con 13 lugares reconocidos
